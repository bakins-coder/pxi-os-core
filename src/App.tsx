  ...
  return (
    <Layout userRole={user.role}>
      <Routes>
        ...
        <Route path="/bakery" element={<ProtectedRoute user={user} requiredPermission="access:catering" allowedRoles={[Role.ADMIN, Role.MANAGER, Role.SALES, Role.CATERING_OPERATIONS_MANAGER]}><FulfillmentHub vertical="Bakery" /></ProtectedRoute>} />
