  ...
  return (
    <Layout userRole={user.role}>
      <Routes>
        ...
        <Route path="/inventory" element={<ProtectedRoute user={user} requiredPermission="access:inventory" allowedRoles={[Role.ADMIN, Role.MANAGER, Role.SALES, Role.CATERING_OPERATIONS_MANAGER, Role.SYSTEM_ADMIN, Role.KITCHEN_MANAGER]}><Inventory /></ProtectedRoute>} />
        <Route path="/catering" element={<ProtectedRoute user={user} requiredPermission="access:catering" allowedRoles={[Role.ADMIN, Role.MANAGER, Role.SALES, Role.CATERING_OPERATIONS_MANAGER, Role.KITCHEN_MANAGER]}><FulfillmentHub vertical="Catering" /></ProtectedRoute>} />
        <Route path="/bakery" element={<ProtectedRoute user={user} requiredPermission="access:catering" allowedRoles={[Role.ADMIN, Role.MANAGER, Role.SALES, Role.CATERING_OPERATIONS_MANAGER, Role.KITCHEN_MANAGER]}><FulfillmentHub vertical="Bakery" /></ProtectedRoute>} />
        <Route path="/retail" element={<ProtectedRoute user={user} requiredPermission="access:catering" allowedRoles={[Role.ADMIN, Role.MANAGER, Role.SALES, Role.CATERING_OPERATIONS_MANAGER]}><FulfillmentHub vertical="Retail" /></ProtectedRoute>} />
        <Route path="/portion-monitor" element={<ProtectedRoute user={user} allowedRoles={[Role.ADMIN, Role.MANAGER, Role.EVENT_MANAGER, Role.EVENT_COORDINATOR, Role.SUPERVISOR, Role.CATERING_OPERATIONS_MANAGER, Role.KITCHEN_MANAGER]}><PortionMonitor /></ProtectedRoute>} />
