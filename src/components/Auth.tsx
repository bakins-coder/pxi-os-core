  ...
  return (
    <div className="w-full max-sm animate-in fade-in slide-in-from-bottom-4">
      ...
      <form onSubmit={handleAuth} className="flex flex-col space-y-6">
        ...
        {sysStatus?.error && (
          <div className="p-4 bg-rose-500/10 border border-rose-500/20 rounded-2xl flex items-center gap-3 text-rose-500 text-xs font-bold uppercase tracking-widest leading-relaxed mb-4">
            <AlertCircle size={16} className="shrink-0" /> System Error: {sysStatus.error}
          </div>
        )}
