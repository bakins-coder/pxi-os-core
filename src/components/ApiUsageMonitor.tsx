...
export const ApiUsageMonitor: React.FC<{ isSidebarCollapsed?: boolean }> = ({ isSidebarCollapsed }) => {
    ...
    return (
        <div className={`fixed bottom-4 left-4 z-[9999] bg-slate-900 text-slate-300 text-xs rounded-lg shadow-xl border border-slate-700 p-3 flex flex-col gap-2 w-48 font-mono opacity-90 hover:opacity-100 transition-all duration-300 backdrop-blur-sm ${isSidebarCollapsed ? 'md:left-[112px]' : 'md:left-[304px]'}`}>
