# Global AI Team Roster

This file maintains the current list of all active AI team members across the Unified Project & Life Management Engine.

| Name | Role | Model | Status |
| :--- | :--- | :--- | :--- |
| **Jimi** | HR & Talent Acquisition | `gemini-1.5-pro` | Active |
...
| **Echo** | Audio & Synthesis specialist | `gemini-1.5-pro` | Active |
| **Lyric** | Content & Narrative Specialist | `gemini-1.5-pro` | Active |
