...
-- Migration: Fix Seed Brochure Menu Items (Retry)
-- Description: Ensures organization exists and populates inventory using the correct table name.

-- 1. Ensure Default Organization Exists
INSERT INTO organizations (name, slug)
VALUES ('Xquisite Catering', 'xquisite-catering')
ON CONFLICT DO NOTHING; -- Assuming name or slug has constraint, or simply rely on existing

-- 2. Insert Menu Items (using correct 'organizations' table)
...
FROM (VALUES
    ...
    -- STARTER (SOUPS)
    ('Goat Meat Pepper Soup', 'Starters', 'Spicy traditional goat meat soup', 500000),
    ...
    ('Chinese Fried Rice', 'Oriental', 'With prawns, lamb fillet, chicken & vegetables', 0),
    ('Stir Fry Noodles', 'Oriental', 'With vegetable and chicken fillet', 0),
    ('Braised Lamb in Oyster Sauce', 'Oriental', 'Sauce Option', 0),
    ('Shredded Spicy Beef', 'Oriental', 'In green peppers', 0),
    ('Prawns in Coconut Sauce', 'Oriental', 'Sauce Option', 0),
    ('Stir Fry Prawns with Peppers', 'Oriental', 'Sauce Option', 0),
    ('Fillet Fish in Crispy Batter', 'Oriental', 'Served with sweet oriental sauce', 0),

    -- THAI
    ('Thai Menu Package', 'Oriental', 'Choice of Sticky Rice or Curry dishes. (N12,500 Per Head)', 1250000),
    ('Sticky Rice with Goat Ribs', 'Oriental', 'Sticky rice served with sticky spicy goat spare ribs', 1250000),
    ...
    ('Apple Crumble', 'Dessert', 'Served with homemade custard or ice cream', 550000),
    ('Use Imported Apples (Extra)', 'Dessert', 'Surcharge for imported apples', 150000),
